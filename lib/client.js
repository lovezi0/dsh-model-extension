  ...
  document.head.appendChild(__tag);
		...
		function QuickLoad(props) {
			...
			*/
			...
			const modelBody = () => {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [hits.map((entry) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					type: "button",
					className: models_plus_module_default["quickItem"],
					onMouseDown: (event) => {
						event.preventDefault();
		...
		*/
		function ModelEntryPanel(props) {
			...
			*/
			const extraCompat = Object.entries(compat).filter(([key]) => !COMPAT_BASE_FIELDS.includes(key)).sort(([a], [b]) => a.localeCompare(b));
			/**
			...
			*/
			const reasoningAreaShown = gateOn || efforts !== void 0 || compat["thinkingFormat"] !== void 0;
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						}), !gateOn && reasoningAreaShown ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
							className: models_plus_module_default["extHint"],
							style: { marginTop: 6 },
					...
					extraCompat.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								...
								children: extraCompat.map(([key, value]) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
									style: {
										display: "flex",
										flexDirection: "column",
										gap: 2
