			...
			*/
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					}) : accountProvider ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ModelCatalog, {
						models,
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [
											...
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
												...
												placeholder: layout === "deepseek" ? DEEPSEEK_BASE_URL : stringAt(fallback, "baseURL") ?? "提供方默认",
												"aria-label": "API 地址",
												disabled,
												onChange: (event) => {
											...
											layout === "deepseek" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												className: models_plus_module_default["advancedHint"],
												children: "该路由固定使用 Messages 协议，地址须指向兼容该协议的端点。"
											}) : null
										]
									}),
